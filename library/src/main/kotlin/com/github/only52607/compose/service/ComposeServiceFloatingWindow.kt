...
public class ComposeServiceFloatingWindow(
    ...
    public fun setContent(content: @Composable () -> Unit) {
        ...
        val currentComposeView = ComposeView(context).apply {
            ...
            // androidx's createLifecycleAwareWindowRecomposer cancels its recomposer whenever
            // the view detaches, which is permanent for an overlay window that detaches and
            // reattaches on every hide()/show() cycle.
