...
import com.github.only52607.compose.service.rememberServiceFloatingWindowInteractionSource
import io.github.arthurkun.keyboard.usage.ui.theme.ComposeFloatingWindowTheme

@Composable
fun FloatingServiceScreen(
    vm: FloatingViewModel = viewModel(),
) {
    val state by vm.state.collectAsStateWithLifecycle()

    val interactionSource = rememberServiceFloatingWindowInteractionSource()
